                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-2">
                      <div className="card">
                      <a href="https://www.facebook.com/andy.madamecila"> 
                      <h1><FontAwesomeIcon className="icons me-1" icon={faFacebook} />
                      </h1>
                      </a>
                      </div>
                    </div>
    ...
    <div class="container">
        <div class="row al">
            <div class="col-md-3 col-sm-6 text-lg-start text-center">
                ...
                <p>Sitio Hugno , Brgy. Manalad, Ilog, N<br/> Negros, Occidental, Philippines</p>
            </div>
            <div class="col-md-3 col-sm-6 text-lg-start text-center">
            <h5 className="fw-bold">
            ...
            <FontAwesomeIcon className="icons me-1" icon={faEnvelope} />
              Email</h5>
                 <p>andymadamecila097@gmail.com</p>
            </div> 
